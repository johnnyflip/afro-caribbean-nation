...
const days = [
  {
    ...
    artists: [
      ...
      { name: "sheryna_dj", genre: "Guest DJ", role: "Headline" },
      { name: "Dj Juliman", genre: "Guest DJ", role: "Headline" },
      { name: "Dj Baha", genre: "Guest DJ", role: "Headline" },
      { name: "Greenjora (afrodisiak)", genre: "Guest DJ", role: "Headline" },
      { name: "Mila Sabadosh", genre: "RnB/pop", role: "Headline" },
      { name: "Booyaka", genre: "Dancehall", role: "Headline" },
      { name: "Jason", genre: "Mc", role: "Headline" },
      { name: "Bergcarter", genre: "Mc", role: "Headline" },
    ],
  },
  {
    day: "Day 02",
    ...
    artists: [
       { name: "UnrulyDJChriz", genre: "Host DJ", role: "Headline" },
      { name: "Unsolvedramon", genre: "Guest DJ", role: "Headline" },
      { name: "Dj Biggy Blaze", genre: "Guest DJ", role: "Headline" },
      { name: "Raul_DJ,", genre: "Guest DJ", role: "Headline" },
      { name: "Dj Juliman", genre: "Guest DJ", role: "Headline" },
      { name: "Lagrace ", genre: "Afrobeats", role: "Headline" },
      { name: "Mila Sabadosh", genre: "RnB/pop", role: "Headline" },
      { name: "Jason", genre: "Mc", role: "Headline" },
      { name: "Bergcarter", genre: "Mc", role: "Headline" },
    ],
  },
  {
    ...
    artists: [
      { name: "UnrulyDJChriz", genre: "Host DJ", role: "Headline" },
      { name: "Dj Steve", genre: "Guest DJ", role: "Headline" },
      { name: "Lordie", genre: "Guest DJ", role: "Headline" },
      { name: "Sandepac", genre: "Guest DJ", role: "Headline" },
      { name: "Dj Juliman", genre: "Guest DJ", role: "Headline" },
      { name: "Jason", genre: "Mc", role: "Headline" },
      { name: "Bergcarter", genre: "Mc", role: "Headline" },
    ],
